...
def map_fn(flags):
    ...
    mymodel = ResNet18(startChannel=8).cuda()
    teacher = gradBranchNet().cuda()
    print(teacher.load_state_dict(torch.load(checkpoint), strict=True))
    teacher.eval()
    ...
    with torch.no_grad():
        ...
        for idx, data in enumerate(train_loader):
            ...
            l1_out, l2_out, l3_out, l4_out, fea, y_pred = mymodel(image, gender)
...
if __name__ == "__main__":
    from model import gradBranchNet
    ...
    save_path = '../../autodl-tmp/distillation_gradBranch_Logit'
    ...
    data_dir = '../../autodl-tmp/grad_fold_1/'
